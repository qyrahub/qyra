...
### Changed
- Build/CI only — no user-facing changes.
- Automated PyPI publishing on `v*` tags via OIDC trusted publishing
  (no long-lived API tokens stored in CI secrets).
- Added ruff lint job and concurrency control to the CI workflow.
...
[Unreleased]: https://github.com/qyrahub/qyra/compare/v0.1.4...HEAD
[0.1.4]: https://github.com/qyrahub/qyra/compare/v0.1.3...v0.1.4
[0.1.3]: https://github.com/qyrahub/qyra/compare/v0.1.2...v0.1.3
